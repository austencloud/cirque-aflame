...
echo "  cirque-app    -> https://github.com/austencloud/cirque-app.git"
echo "  cirque-website -> https://github.com/austencloud/cirque-website.git"
echo ""
read -p "Press Enter to continue or Ctrl+C to cancel..."

# Add remotes
git remote add cirque-app https://github.com/austencloud/cirque-app.git 2>/dev/null || echo "Remote cirque-app already exists"
